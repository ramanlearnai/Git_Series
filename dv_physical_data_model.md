...
erDiagram
    ...
    SAT_CLIENT {
        BINARY_32 CLIENT_HK PK_FK "NOT NULL"
    ...
    SAT_PRODUCT {
        BINARY_32 PRODUCT_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_GL_ACCOUNT {
        BINARY_32 GL_ACCOUNT_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_DEPARTMENT {
        BINARY_32 DEPARTMENT_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_DATE {
        BINARY_32 DATE_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_REVENUE {
        BINARY_32 REVENUE_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_EXPENSE {
        BINARY_32 EXPENSE_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
    ...
    SAT_BUDGET {
        BINARY_32 BUDGET_HK PK_FK "NOT NULL"
        TIMESTAMP_NTZ LOAD_DTS PK "NOT NULL"
        TIMESTAMP_NTZ LOAD_END_DTS "DEFAULT 9999-12-31"
        VARCHAR_20 REC_SRC "NOT NULL"
        BINARY_32 HASH_DIFF "SHA-256, NOT NULL"
